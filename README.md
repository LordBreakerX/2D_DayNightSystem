...
> ℹ️ **Note:** If you imported the `DayNightSystem2D_WithDemo` package and want to remove the demo content, you can delete the `LordBreakerX/...` folder from your project's `Assets` directory.
